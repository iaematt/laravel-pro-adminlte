...
class UserController extends Controller
{
    ...
    public function updateProfile(User $user, Request $request)
    {
        ...
        return back()->with('status', 'O perfil do usuário foi atualizado com sucesso.');
    }
    ...
    public function updateInterests(User $user, Request $request)
    {
        ...
        return back()->with('status', 'Os interesses do usuário foram atualizado com sucesso.');
    }
    ...
    public function updateRoles(User $user, Request $request)
    {
        ...
        return back()->with('status', 'Os cargos do usuário foram atualizado com sucesso.');
    }
